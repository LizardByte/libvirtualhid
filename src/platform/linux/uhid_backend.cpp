  ...
  namespace {  // NOSONAR(cpp:S1000): Linux backend internals need internal linkage; tests include this file with syscall overrides.
    ...
    DeviceProfile uhid_transport_profile(const DeviceProfile &requested_profile, bool include_battery) {
      ...
      if (is_xbox_uhid_profile(requested_profile.gamepad_kind)) {
        ...
        transport_profile.report_descriptor = xbox_bluetooth::make_xbox_bluetooth_report_descriptor(include_battery);
      }
    ...
    public:
      ...
      OperationStatus submit(
        ...
        const auto transport_report = is_xbox_uhid_profile(profile_.gamepad_kind) ?
                                        xbox_bluetooth::make_xbox_bluetooth_input_report(
                                          state,
                                          report,
